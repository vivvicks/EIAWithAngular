...
namespace EIAwithAngular.Repository
{
    ...
    {
        public static int ExecProcedure(this Database self, string storedProcedure, object parameters = null)
        {
            if (self == null)
        ...
        public static IEnumerable<TElement> ExecProcedure<TElement>(this Database self, string storedProcedure, object parameters = null)
        {
            if (self == null)
                throw new ArgumentNullException("self");
            if (string.IsNullOrEmpty(storedProcedure))
        ...
        public static IEnumerable ExecProcedure(this Database self, Type elementType, string storedProcedure, object parameters = null)
        {
            if (self == null)
                throw new ArgumentNullException("self");
            if (elementType == null)
